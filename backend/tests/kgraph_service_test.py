...
async def init() -> None:
    ...
    if result:
        ...
        try:
            ...
            print(f"Saved raw knowledge graph data")
        except Exception as e:
            print(f"Warning: Could not save raw data")

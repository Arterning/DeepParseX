...
INSERT INTO public.sys_menu (id, title, name, level, sort, icon, path, menu_type, component, perms, status, show, cache, remark, parent_id, created_time, updated_time) VALUES (76, '上传任务', 'UploadTask', 0, 0, 'IconPlayArrow', 'upload-task', 1, '/data/upload-task/index.vue', null, 1, 1, 1, null, 43, '2025-09-26 01:33:07.676667 +00:00', '2025-09-26 01:33:45.825054 +00:00');
